...
class EquipamentosTab(BaseTab):
    ...
    def _init_campos_servico(self):
        ...
        # Dropdown dinâmico de tipo de serviço
        ...
        # Campo para digitar novo tipo (oculto por padrão)
    ...
    def _confirmar_exclusao(self, eq):
        ...
        def confirmar(e):
            ...
            if ok:
                if self.equipamento_selecionado and self.equipamento_selecionado.get('id') == eq['id']:
                    self.equipamento_selecionado = None
        ...
        if not equipamentos_ordenados:
            ...
            itens = [
                ft.Container(
                    ...
                    bgcolor=self.get_adaptive_color(ft.Colors.BLUE_GREY_900, ft.Colors.GREY_300),
                    border_radius=6,
                ),
            ]
    ...
    def salvar_equipamento(self, e):
        ...
        try:
            ...
            # Atualiza a lista lateral se estiver na view de cadastro
            if self.view_atual == "cadastro" and hasattr(self, 'lista_panel'):
                self.lista_panel.content = self._build_lista_equipamentos().content
            self.page.update()
    ...
    def mostrar_servicos(self):
        ...
        # Atualizar tipos de serviço com customizados mais recentes
        self._rebuild_tipo_servico_dropdown()
        self.novo_tipo_row.visible = False
        self.novo_tipo_field.value = ""
