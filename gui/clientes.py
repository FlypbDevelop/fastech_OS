        ...
        return ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Row(
                        [
                            self.botao_primario("💾 Salvar", on_click=self.confirmar_salvar_cliente, expand=True),
                    ...
                    ft.ResponsiveRow(
                        [
                            ...
                            ft.Container(
                                content=ft.Row(
                                    [
                                        self.botao_primario("🔍 Buscar", on_click=lambda e: self.buscar_clientes(), expand=True),
                                        self.botao_primario("🔄 Todos", on_click=lambda e: self.carregar_clientes(), expand=True),
                                    ],
                                    spacing=10,
                                ),
                                col={"sm": 12, "md": 6, "lg": 6},
    ...
    def confirmar_salvar_cliente(self, e):
        ...
        dialogo = ft.AlertDialog(
            ...
            actions=[
                ...
                self.botao_primario("Confirmar", on_click=confirmar),
            ],
        )
