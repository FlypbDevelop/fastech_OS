...
description: Design thinking and decision-making for web UI components, layouts, color schemes, typography, and aesthetic interfaces. Teaches principles, not fixed values. Use when designing components, layouts, or creating visual interfaces.
license: MIT
allowed-tools:
  - Read
  - Write
